<?php
require_once '../functions/connection.php';  // Ensure this file properly initializes the $pdo object
...
$achievements = getAchievements(); // Assuming this function is properly defined and returns the necessary data
        ...
        <div class="modal-body">
            ...
            <div id="selectedStudentInfo" class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-floating mb-3">
                            <input class="form-control" id="lastname" type="text" name="lastname" value="<?php echo $student['lastname'] ?? ''; ?>">
                            <label class="form-label" for="lastname">Lastname:</label>
                        </div>
                    </div>
                </div>
...
function previewProfilePic() {
    ...
    const previewImage = document.getElementById('studentImage');
...
document.getElementById('course').addEventListener('change', function() {
    ...
    if (courseId) {
        // Fetch and populate majors based on the selected course
...
function fetchMajors(courseId) {
    // Example AJAX request to fetch majors based on course
    fetch(`../functions/getMajors.php?course_id=${courseId}`)
